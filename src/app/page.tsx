...
import { ArrowRight, Trophy, BookOpen, Clock, Heart, User, Plus } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-[#F5F5F7] font-sans pb-32">
      ...
      <nav className="sticky top-0 z-50 bg-[#F5F5F7]/80 backdrop-blur-xl border-b border-black/5 px-6 py-4 flex items-center justify-between">
        ...
        <Link href="/auth" className="px-4 py-2 bg-gray-900 text-white rounded-full text-sm font-bold shadow-md shadow-black/10 hover:bg-black transition-colors active:scale-95">Kirish</Link>
      </nav>
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 mt-8 space-y-12">
        ...
        <section>
          ...
          <div className="relative w-full h-[480px] sm:h-[400px] bg-white rounded-[32px] overflow-hidden shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-8 flex flex-col sm:flex-row items-center justify-between gap-8">
            ...
            <div className="relative z-10 flex flex-col items-center sm:items-start text-center sm:text-left flex-1 max-w-sm">
              ...
              <h1 className="text-4xl sm:text-5xl font-extrabold text-gray-900 tracking-tight mb-3">Diqqat</h1>
              <p className="text-gray-500 font-medium mb-8 leading-relaxed">
                Kel Nyuport qalamiga mansub bu asar chalg'ituvchi dunyoda muvaffaqiyat sirlarini ochib beradi.
              </p>
              
              <div className="flex gap-3 w-full sm:w-auto">
                <Link href="/book/1" className="flex-1 sm:flex-none bg-orange-500 hover:bg-orange-600 text-white font-bold py-3.5 px-8 rounded-full shadow-lg shadow-orange-500/25 transition-transform active:scale-95 text-sm flex items-center justify-center">
                  Mutolaani boshlash
                </Link>
              </div>
            </div>
            ...
            <div className="relative z-10 w-full sm:w-auto flex justify-center mt-4 sm:mt-0">
              <div className="w-[180px] aspect-[2/3] rounded-xl shadow-2xl overflow-hidden transform sm:rotate-3 transition-transform hover:rotate-0 duration-500 ring-1 ring-black/5">
                <img src="/images/books/ref2.png" alt="Diqqat Book Cover" className="w-full h-full object-cover bg-gray-100" />
              </div>
            </div>
        ...
        <section>
          <div className="flex items-center justify-between mb-5 px-2">
            <h2 className="text-[28px] font-bold text-gray-900 tracking-tight">Oltin Meros</h2>
          </div>
          
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
            
            {/* Book 1 */}
            <Link href="/book/1" className="group cursor-pointer block">
              ...
              <div className="px-2">
                <h3 className="text-base font-bold text-gray-900 leading-tight truncate">O'tkan Kunlar</h3>
                <p className="text-[13px] text-gray-500 font-medium mt-1">Abdulla Qodiriy</p>
              </div>
            </Link>

            {/* Book 2 */}
            <Link href="/book/2" className="group cursor-pointer block">
              <div className="bg-white rounded-[28px] p-6 aspect-[4/5] flex items-center justify-center shadow-[0_8px_30px_rgb(0,0,0,0.03)] mb-4 transition-transform duration-300 group-hover:-translate-y-1">
                <div className="w-full max-w-[130px] aspect-[2/3] rounded-lg shadow-md overflow-hidden group-hover:shadow-xl group-hover:scale-105 transition-all duration-300 ring-1 ring-black/5">
              ...
              <div className="px-2">
                <h3 className="text-base font-bold text-gray-900 leading-tight truncate">Jinoyat va Jazo</h3>
                <p className="text-[13px] text-gray-500 font-medium mt-1">F. Dostoyevskiy</p>
              </div>
            </Link>
