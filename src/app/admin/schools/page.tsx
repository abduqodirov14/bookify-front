  ...
  useEffect(() => {
    b2bService.getSchools()
      ...
      .catch(err => {
        ...
        setSchools([]); // Fallback to empty if backend is not ready
      })
      .finally(() => {
        setLoading(false);
      });
    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="bg-white p-6 rounded-[24px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 flex items-center gap-4">
          ...
          <div>
            <div className="text-2xl font-black text-gray-900">{schools.length} ta</div>
        ...
        <div className="bg-white p-6 rounded-[24px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 flex items-center gap-4">
          ...
          <div>
            <div className="text-2xl font-black text-gray-900">
              {schools.reduce((acc, s) => acc + (s.activeStudents || 0), 0)}
            </div>
        ...
        <div className="bg-white p-6 rounded-[24px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 flex items-center gap-4">
          ...
          <div>
            <div className="text-2xl font-black text-gray-900">Real API</div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse">
            ...
            <tbody className="divide-y divide-gray-100">
              {loading ? (
                <tr>
                  <td colSpan={6} className="p-8 text-center text-gray-500 font-bold">Yuklanmoqda...</td>
                </tr>
              ) : schools.length === 0 ? (
                 <tr>
                  <td colSpan={6} className="p-12 text-center">
                    ...
                    <div className="text-gray-500 font-bold">Hali maktablar mavjud emas (API bo'sh)</div>
                    <div className="text-xs text-gray-400 mt-1">Yangi maktab qo'shing yoki Backendni tekshiring</div>
                  </td>
                </tr>
              ) : (
                schools.map(school => (
