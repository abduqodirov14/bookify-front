...
export const BOOKS: Book[] = [
  ...
  // в”Ђв”Ђ CONFIRMED PUBLIC DOMAIN вЂ” PROJECT GUTENBERG в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
...

  {
    ...
    reviewsCount: 0,
    narrator: undefined,
    featuredQuote: "Azob вЂ” bu ulug'likdir. Insonlar buyuk bo'lish uchun azob chekishadi.",
    chapters: [
      {
        id: "jj1",
        number: 1,
        title: "1-Bob: Haymarket ko'chasi",
        content: `Iyulning boshida, shom quyoshi botishga yaqin, bir kichkina mansardadan ko'chaga chiqqan yosh talaba Haymarket maydoniga qarab sekin yurib ketdi.\n\nSariq, issiq havo unga og'ir botayotgan edi. Uni asab ezayotgan edi, lekin bu safar qo'rquv emas вЂ” boshqa bir narsa edi. Bir qaror pishib qolgandek edi ichida.`
      }
    ]
  },

  {
    ...
    spineColor: "#0D1B2A",
    description: "Ota Fyodor Karamazov va uning uch o'g'li вЂ” Dmitriy, Ivan va Alyosha вЂ” o'rtasidagi ruhiy va falsafiy ziddiyat. Xudo, axloq, aql va imon haqidagi Dostoyevskiyning so'nggi va eng buyuk romani.",
    publishedYear: 1880,
    pages: 796,
    audioDuration: "",
    rating: 4.9,
    ...
    chapters: [
      {
        ...
        content: `Aleksey Fyodorovich Karamazov bizning uyezdimizning bir yer egasining kenja o'g'li edi. Bu yer egasi вЂ” Fyodor Pavlovich Karamazov вЂ” o'z vaqtida tarqoq va g'alati odam sifatida tanilgan edi, lekin asli baxtsiz emas, aksincha, juda ham amaliy odam edi.`
      }
    ]
  },

  {
    ...
    spineColor: "#1A1A2E",
    description: "Siyosiy nihilizm va inqilobiy harakatga keskin tanqid. Nikolay Stavrogin boshchiligidagi maxfiy guruh shaharchani falokatga sГјrГјklyaydi. Dostoyevskiy bu romanda g'oyaviy radikalizm qanchalik halokatli bo'lishini ko'rsatadi.",
    publishedYear: 1872,
    pages: 768,
    audioDuration: "",
    rating: 4.8,
    reviewsCount: 0,
    narrator: undefined,
    featuredQuote: "Agar Xudo yo'q bo'lsa, men вЂ” Xudoman.",
    chapters: [
      {
        id: "ibl1",
        number: 1,
...

  {
    ...
    reviewsCount: 0,
    narrator: undefined,
    featuredQuote: "Hammasi o'tadi вЂ” azob ham, quvonch ham. Abadiy narsa вЂ” faqat sevgi.",
    chapters: [
      {
        id: "ut1",
        number: 1,
        title: "1-Bob: Anna Pavlovnaning ziyofati",
        content: `вЂ”Eh bien, mon prince. Genuya va Lukka endi Bonapartning shaxsiy mulkiga aylandi. Men sizni ogohlantirayapman вЂ” agar siz bu yerdagi ahvolni hali ham qanday bo'lmasin deb qarasangiz...\n\nShunday dedi Anna Pavlovna Sherer, 1805 yilning iyulida taniqli davlat arbobi knyaz Vasiliyni qabul qila turib.`
      }
    ]
  },

  {
    ...
    reviewsCount: 0,
    narrator: undefined,
    featuredQuote: "Kimdir Jozef K.ga tuhmat qilgan bo'lsa kerak вЂ” sabab noma'lum, ammo u qamoqqa olindi.",
    chapters: [
      {
        id: "mm1",
        number: 1,
        title: "1-Bob: O'zgarish",
        content: `Grigori Zamza bir kuni ertalab notinch tushlardan uyg'onib, karavotida o'zini hasharotga aylangan holda ko'rdi. U qattiq, qobiqli orqasiga ag'anagan edi; boshini ko'tarsa, qorin tomonini ko'rdi вЂ” qo'ng'ir, qavariqlangan, qalin.`
      }
    ]
  },

  {
    ...
    reviewsCount: 0,
    narrator: undefined,
    featuredQuote: "Erkinlik вЂ” osmon o'z in'om etgan eng qimmatli ne'matdir.",
    chapters: [
      {
        id: "dk1",
        number: 1,
        title: "1-Bob: La Manchali fidoyi",
        content: `La Mancha viloyatida, nomi yodimda qolmagan bir qishloqda, yaqinda bir hidalgo yashardi вЂ” u doimiy ravishda nayzalar, eski qalqon, ko'hna ot va quvg'in it bilan yashardi.\n\nU qishilmas ovchi edi va ko'p vaqtini ritsarlik romanlari mutolaa qilishga sarflardi.`
      }
    ]
  },
    ...
    chapters: [
      {
        id: "mk1",
        number: 1,
        title: "1-Bob: Marseyl вЂ” Kemaning kelishi",
        content: `1815 yilning 24 fevralida Marseyl limonga В«FaraonВ» kemasД± kirib keldi. Bu kema Smirna, Triest va Neapoldan kelgan edi. Kemadagi dengizchilar qanchalik quvnoq ko'rinsalar, kapitan shunchalik g'amgin edi.`
      }
    ]
  },

  {
    ...
    reviewsCount: 0,
    narrator: undefined,
    featuredQuote: "Hayot вЂ” bu yovvoyilikka qaytish; kuchli bo'l, yoki o'l.",
    chapters: [
      {
        id: "yc1",
        number: 1,
